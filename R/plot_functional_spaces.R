plots_alpha <- mFD::alpha.multidim.plot(
  ...
  color_sp = c(pool = "grey50", asb1 = "#D62246", asb2 = NA),
  color_vert = c(pool = "grey50", asb1 = "#D62246", asb2 = NA),
  fill_sp = c(pool = NA, asb1 = "#FFFFFF30", asb2 = "#FFFFFF30"),
  fill_vert = c(pool = NA, asb1 = "#D62246", asb2 = NA),
  color_ch = c(pool = "grey80", asb1 = "#D62246", asb2 = NA),
  fill_ch = c(pool = "white", asb1 = "#D62246", asb2 = NA),
...
ggsave("functional_space_PC3_upper.png", path = "figures", dpi = 700, height = 2.5, width = 2.5)
