...
```{r}
#| echo: true
#| label: ses_depth_layer_richness_model
#| warning: false
#| message: false
#| fig-width: 6
#| fig-height: 6
...
results_df <- tidyr::pivot_longer(SES_results, cols = -depth_layer, names_to = "Index", values_to = "SES_FD")
