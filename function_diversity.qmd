...
data_2021_mat <- data2021 %>%
  ...
  pivot_wider(names_from = Nom_Scientifique, values_from = abundance)%>%
  replace(is.na(.), 0)
...
morphometric_data <- utils::read.csv(here::here("data","raw-data", "morphometrics_data.csv"), sep = ";", header = T, dec = ".")
...
DT::datatable(morpho_data_summary)
